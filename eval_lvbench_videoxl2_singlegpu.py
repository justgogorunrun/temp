...
import sys
sys.path.append("/remote-home/zhangkc/Video-XL/Video-XL-2/train/")

from videoxl2.constants import (
    DEFAULT_IMAGE_TOKEN,
    IMAGE_TOKEN_INDEX,
)
from videoxl2.conversation import SeparatorStyle, conv_templates
from videoxl2.model.builder import load_pretrained_model
from videoxl2.mm_utils import (
...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default="/remote-home/zhangkc/Video-XL/Video-XL-2/models/Video-XL-2", help="videoxl2 checkpoint path")
    parser.add_argument("--data_root", type=str, default="/remote-home/zhangkc/data/temp_zc/LVBench/data", help="LVBench data root")
    ...
    parser.add_argument("--max_frame_num", type=int, default=256)
    parser.add_argument("--fps", type=int, default=1)
    parser.add_argument("--max_fps", type=int, default=2)
    ...
    parser.add_argument("--prompt_style", type=str, default="lmmseval", choices=["videochat2", "lmmseval"])
    parser.add_argument(
        "--root_prompt",
        type=str,
        default=None,
