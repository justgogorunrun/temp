...
if __name__ == "__main__":
    ...
    args.add_argument("--output_dir", type=str, default="mytest/qwenvl2_output_newest") # longva7b_output 是复现的训练好的原始模型论文结果 longva_qwen1.5b_eventbench  longva7b_eventbench
