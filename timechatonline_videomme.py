...
MIN_PIXELS = 360*420 #448*448
MAX_PIXELS = 360*420 #448*448
MAX_FRAMES = 900
MIN_FRAMES = 4
FPS = 1
...
if __name__ == "__main__":
    ...
    # 保存fps变量
    torch.save(model.model.tokens_drop_number, "/remote-home/zhangkc/TimeChat-Online-main/eval/fps/tokens_drop_number.pt")
    torch.save(model.model.tokens_original_number, "/remote-home/zhangkc/TimeChat-Online-main/eval/fps/tokens_original_number.pt")
    torch.save(model.model.time_tokens_drop, "/remote-home/zhangkc/TimeChat-Online-main/eval/fps/time_tokens_drop.pt")
