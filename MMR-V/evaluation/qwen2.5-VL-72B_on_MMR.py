...
# breakpoint()
# 从环境变量中获取 API 密钥
os.environ['DASHSCOPE_API_KEY'] = 'sk-9ed69c300b80464381b7c875b8e996ea'
...
if __name__ == '__main__':
    ...
    save_file =  f'/remote-home/share/_datasets/MMR-VBench/results/{model_name}_on_MMR.json' #f'/netdisk/zhukejian/implicit_video_anonotations/results/{model_name}_on_MMR.json'
    visual_path = '/remote-home/share/_datasets/MMR-VBench/videos' #f'/netdisk/zhukejian/implicit_video_anonotations/static/videos'
    results = []
    client = OpenAI(
        model_version= '/mnt/usercache/zhuoran/rl/Qwen2.5-VL-72B-Instruct', # '/netcache/zhuoran/rl/Qwen2.5-VL-7B-Instruct',
        api_type='openai',
        api_key=api_key,
        api_url="http://210.75.240.153:22277/v1/chat/completions",
    ) 
