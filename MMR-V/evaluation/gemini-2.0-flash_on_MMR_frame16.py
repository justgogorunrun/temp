...
if __name__ == '__main__':
    ...
    # save_file = f'/netdisk/zhukejian/implicit_video_anonotations/results/{model_name}_on_MMR_V_frame16.json'
    # visual_path = '/netdisk/zhukejian/implicit_video_anonotations/static/videos'
    save_file =  f'/mnt/userdata/implicit_video_anonotations/results/{model_name}_on_MMR_V_frame16.json' #f'/netdisk/zhukejian/implicit_video_anonotations/results/{model_name}_on_MMR.json'
    visual_path = '/mnt/userdata/implicit_video_anonotations/static/videos' #f'/netdisk/zhukejian/implicit_video_anonotations/static/videos'
